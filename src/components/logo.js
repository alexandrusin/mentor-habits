...
const Logo = ({ color }) => (
    <svg className="logo" x="0px" y="0px" viewBox="0 0 100 100">
        <g className="logo-head">
            <path d="M41,69.8L54.4,71c0.8,0.1,1.5-0.6,1.5-1.4v-6.3c0-0.4,0.3-0.7,0.7-0.7h4.7c1.4,0,2.6-1.2,2.6-2.6v-6.3
        ...
        <g className="logo-arrows">
            <path d="M70.9,75.1c-6,5.1-13.6,7.8-21.4,7.8c-18.3,0-33.2-14.9-33.2-33.2v-2.8h5.3c1,0,1.9-0.5,2.3-1.4c0.5-0.8,0.4-1.9-0.1-2.7
            ...
            <path d="M96.8,53.9c-0.5-0.8-1.4-1.4-2.3-1.4h-5.3v-2.8c0-21.8-17.8-39.6-39.6-39.6c-9.4,0-18.4,3.3-25.6,9.4
            ...
            <animateTransform attributeType="xml" attributeName="transform" type="rotate" from="0 50 50" to="360 50 50" begin="0" dur="10s" repeatCount="indefinite" />
        </g>
    </svg>
)
